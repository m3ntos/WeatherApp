 ...
 *
 * Modified 2018 by Rafał Wojnecki
 */
...
import com.example.rafal.weatherapp.utils.SunshineDateUtils;
import com.example.rafal.weatherapp.utils.SunshineWeatherUtils;
...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
         ...
         * Weather Icon *
         ****************/
        int weatherConditionId = currentWeather.getWeatherConditionId();
        int weatherImageResourceId = getImageResourceId(weatherConditionId, position);
         ...
         * Weather Description *
         ***********************/
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, weatherConditionId);
         ...
         **************************/
        double highInCelsius = currentWeather.getMaxTemperature();
         /*
         ...
         * Low (min) temperature *
         *************************/
        double lowInCelsius = currentWeather.getMinTemperature();
         /*
          * If the user's preference for weather is fahrenheit, formatTemperature will convert
          * the temperature. This method will also append either °C or °F to the temperature
          * String.
    ...
    private int getLayoutIdByType(int viewType) {
        switch (viewType) {
            ...
            case VIEW_TYPE_TODAY: {
                return R.layout.item_forecast_list_today;
            }
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            int id = mForecast.get(adapterPosition).getId();
